...
def customize_compiler_for_nvcc(self):
    ...
    def _compile(obj, src, ext, cc_args, extra_postargs, pp_opts):
        if os.path.splitext(src)[1] == '.cu':
            ...
            postargs = extra_postargs['nvcc'] + ['-I/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi', '-I/usr/lib/x86_64-linux-gnu/openmpi/include', '-L/usr/lib/x86_64-linux-gnu/openmpi/lib']
        else:
            postargs = extra_postargs['gcc'] + extra_postargs['openmp'] + extra_postargs['mpi']
...
module = Extension('muesli', sources=['muesli.cu'],
                   ...
                   extra_compile_args={'gcc': [],
                                       'nvcc': [
                                           ...
                                           '--compiler-options', "'-fPIC'", '-lmpi_cxx', '-lmpi', '-Xcompiler', '-fopenmp'
