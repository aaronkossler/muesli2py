...
#SBATCH --job-name pybind-MPI-mandelbrot-8Nodes-parallel
#SBATCH --output /scratch/tmp/n_herr03/aaron/8nodefoss-data-small.csv
#SBATCH --error /scratch/tmp/n_herr03/aaron/8nodefoss-error.dat
