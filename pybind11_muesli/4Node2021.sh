...
#SBATCH --job-name pybind-4Nodes-MPI-mandelbrot-parallel
#SBATCH --output /scratch/tmp/n_herr03/aaron/4nodefoss-data-small-cont.csv
#SBATCH --error /scratch/tmp/n_herr03/aaron/4nodefoss-error.dat
